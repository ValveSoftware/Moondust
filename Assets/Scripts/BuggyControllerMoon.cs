...
{
    public class BuggyControllerMoon : MonoBehaviour
    {
        private static List<BuggyControllerMoon> controllers = new List<BuggyControllerMoon>();

        public static BuggyControllerMoon FindControllerForBuggy(BuggyBuddy buggy)
        {
            Debug.Log(controllers[1].buggy);
            return controllers.Find(c => c.buggy == buggy);
        }
